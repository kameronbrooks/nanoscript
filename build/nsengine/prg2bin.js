...
exports.NSBinaryComplier = void 0;
const program_1 = require("./program");
class NSBinaryComplier {
    stringToBytes(str) {
    ...
    appendBytes(buffer, bytes, offset) {
        for (let i = 0; i < bytes.length; i++) {
            buffer[offset++] = bytes[i];
        }
        return offset;
    }
    compileBinary(program) {
...
exports.NSBinaryComplier = NSBinaryComplier;
