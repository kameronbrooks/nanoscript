...
import { ASTNode, BinaryOpNode} from "../ast";

export class InterpretBinarySpread extends InterpreterStep {
    constructor(interpreter: Interpreter, nextStep: InterpreterStep | null = null) {
        super("InterpretBinarySpread", "Interpreting binary spread ", interpreter, nextStep);
    }
    ...
    execute(params?: InterpreterStepParams): ASTNode | undefined| null {
        ...
        if (!this.interpreter.isEOF() && this.interpreter.match("ELLIPSIS")) {
